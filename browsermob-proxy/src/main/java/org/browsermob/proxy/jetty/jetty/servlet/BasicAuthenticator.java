 ...
 * 
 */
public class BasicAuthenticator extends
		org.browsermob.proxy.jetty.http.BasicAuthenticator {

	/* ------------------------------------------------------------ */
	/*
	 * @see
	 * org.browsermob.proxy.jetty.http.BasicAuthenticator#sendChallenge(org.
