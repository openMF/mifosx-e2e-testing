...
public class Password extends Credential {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.browsermob.proxy.jetty.util.Credential#check(java.lang.Object)
	 */
	 ...
	 * @return Password
	 */
	public static Password getPassword(String realm, String dft,
			String promptDft) {
		...
		if (passwd == null || passwd.length() == 0) {
			try {
				System.out
						.print(realm
								+ ((promptDft != null && promptDft.length() > 0) ? " [dft]"
										: "") + " : ");
				System.out.flush();
	...
	public static void main(String[] arg) {
		if (arg.length != 1 && arg.length != 2) {
			System.err
					.println("Usage - java org.browsermob.proxy.jetty.util.Password [<user>] <password>");
			System.err
