 ...
 * with the command "java -jar
 * start.jar". The behaviour of Main is controlled by the "
 * org/browsermob/proxy/jetty/start/start.config" file obtained as a resource or
 * file. This can be overridden with the START system property. The format of
