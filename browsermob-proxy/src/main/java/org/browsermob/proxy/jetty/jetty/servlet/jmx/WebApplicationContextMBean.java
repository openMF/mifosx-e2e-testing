...
/* ------------------------------------------------------------ */
/**
 * Web Application MBean. Note that while Web Applications are HttpContexts, the
 * MBean is not derived from HttpContextMBean as they are managed differently.
 * 
...
public class WebApplicationContextMBean extends ServletHttpContextMBean {
	...
	private static final Log log = LogFactory
			.getLog(WebApplicationContextMBean.class);
	 ...
	 * 
	 * @see
	 * org.browsermob.proxy.jetty.jetty.servlet.jmx.ServletHttpContextMBean#
	...
	/**
	 * postDeregister Unregister mbeans we created for the Configuration
	 * objects.
	 * 
	...
	/**
	 * getConfigurations Make mbeans for all of the Configurations applied to
	 * the WebApplicationContext.
	 * 
	 * @return the configurations
	 */
	public ObjectName[] getConfigurations() {
		return getComponentMBeans(_webappContext.getConfigurations(),
				_configurations);
	}
