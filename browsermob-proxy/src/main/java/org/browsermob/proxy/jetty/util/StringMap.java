...
/* ------------------------------------------------------------ */
/**
 * Map like class of Strings to Objects. This String Map has been optimized for
 * mapping small sets of Strings where the most frequently accessed Strings have
 * been put to the map first.
 * 
 * It also has the benefit that it can look up entries by substring or sections
 * of char and byte arrays. This can prevent many String objects from being
 * created just to look up in the map.
 * 
...
public class StringMap extends AbstractMap implements Externalizable {
	 ...
	 *            the ignore case
	 * @param width
	 *            Width of hash tables, larger values are faster but use more
	 *            memory.
	 */
	...
	public Object put(String key, Object value) {
		...
		charLoop: for (int i = 0; i < key.length(); i++) {
			...
			if (ni == -1) {
				...
				prev = null;
				ni = 0;
				node = (node._children == null) ? null : node._children[c
						% _width];
			}
	 ...
	 * @param offset
	 *            Offset of the key within the String.
	 * @param length
	 ...
	 * 
	 * @param key
	 *            char array containing the key
	 * @param offset
	 *            Offset of the key within the array.
	 * @param length
	 *            The length of the key
	 * @return The Map.Entry for the key or null if the key is not in the map.
	 */
	 ...
	 * 
	 * @param key
	 *            byte array containing the key. A simple ASCII byte to char
	 *            mapping is used.
	 * @param offset
	 *            Offset of the key within the array.
	 * @param length
	...
	public boolean containsKey(Object key) {
		...
		return getEntry(key.toString(), 0, key == null ? 0 : key.toString()
				.length()) != null;
	}
