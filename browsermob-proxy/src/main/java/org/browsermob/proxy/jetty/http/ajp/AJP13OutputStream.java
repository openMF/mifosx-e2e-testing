...
import org.browsermob.proxy.jetty.http.BufferedOutputStream;
...
public class AJP13OutputStream extends BufferedOutputStream {
	...
	/* ------------------------------------------------------------ */
	/**
	 * Instantiates a new aJ p13 output stream.
	 * 
	 * @param out
	 *            the out
	 * @param bufferSize
	...
	AJP13OutputStream(OutputStream out, int bufferSize) {
		super(out, bufferSize, AJP13ResponsePacket.__DATA_HDR,
				AJP13ResponsePacket.__DATA_HDR, 1);
		setFixed(true);
	 ...
	 * 
	 * @see
	 * org.browsermob.proxy.jetty.http.BufferedOutputStream#writeHeader(org.
	 * browsermob.proxy.jetty.http.HttpMessage)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.browsermob.proxy.jetty.http.BufferedOutputStream#flush()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.browsermob.proxy.jetty.http.BufferedOutputStream#destroy()
	 */
	public void destroy() {
		if (_packet != null)
			_packet.destroy();
	 ...
	 * 
	 * @see
	 * org.browsermob.proxy.jetty.util.ByteBufferOutputStream#writeTo(java.io
	 * .OutputStream)
	 */
	public void writeTo(OutputStream out) throws IOException {
		...
		if (sz <= AJP13ResponsePacket.__MAX_BUF)
			...
			while (data > AJP13ResponsePacket.__MAX_DATA) {
				_packet.setDataSize(AJP13ResponsePacket.__MAX_BUF
						- AJP13ResponsePacket.__HDR_SIZE);
				if (offset > 0)
					System.arraycopy(_buf, 0, _buf, offset,
