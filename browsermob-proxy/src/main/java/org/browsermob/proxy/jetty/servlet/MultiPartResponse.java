 ...
 * 
 * 
 * @version $Id: MultiPartResponse.java,v 1.6 2004/05/09 20:32:41 gregwilkins
 *          Exp $
 * @author Greg Wilkins
 * @author Jim Crossley
 */
public class MultiPartResponse extends
		org.browsermob.proxy.jetty.http.MultiPartResponse {
	/* ------------------------------------------------------------ */
	/**
	 * MultiPartResponse constructor.
	 * 
	 * @param response
	 *            The ServletResponse to which this multipart response will be
	 *            sent.
	 * @throws IOException
