 ...
 * 
 * @version $Id: SetResponseHeadersHandler.java,v 1.6 2005/08/13 00:01:26
 *          gregwilkins Exp $
 * @author Brett Sealey
 */
public class SetResponseHeadersHandler extends AbstractHttpHandler {
	...
	/* ------------------------------------------------------------ */
	/**
	 * The Map of _fields that will be asserted on outgoing responses. Key is
	 * the header name. Value is a List containing its values.
	 */
	...
	/* ------------------------------------------------------------ */
	/**
	 * Set a multivalued header, every response handled will have this header
	 * set with the provided values.
	 * 
	 * @param name
	 *            The String name of the header.
	 * @param values
	...
	/* ------------------------------------------------------------ */
	/**
	 * Handle a request by pre-populating the headers from the configured set of
	 * _fields.
	 * 
	 ...
	 * 
	 * @param pathInContext
	 *            The context path. Ignored.
	 * @param pathParams
	 *            Path parameters such as encoded Session ID. Ignored.
	 * @param request
	 *            The HttpRequest request. Ignored.
	 * @param response
	...
	public void handle(String pathInContext, String pathParams,
		...
		for (Iterator iterator = _fields.entrySet().iterator(); iterator
				.hasNext();) {
