...
/**
 * Handler to force MSIE SSL connections to not be persistent to work around
 * MSIE5 bug.
 * 
 * @author gregw
 * @author chris haynes
...
public class MsieSslHandler extends AbstractHttpHandler {
	...
	public void handle(String pathInContext, String pathParams,
		...
		if (userAgent != null
				...
				&& HttpRequest.__SSL_SCHEME.equalsIgnoreCase(request
						.getScheme())) {
	...
	/**
	 * Gets the user agent sub string.
	 * 
	...
	/**
	 * Sets the user agent sub string.
	 * 
	 * @param string
