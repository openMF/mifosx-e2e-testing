...
public class TypeUtil {
	...
	/* ------------------------------------------------------------ */
	/** The int cache size. */
	private static int intCacheSize = Integer.getInteger(
			"org.browsermob.proxy.jetty.util.TypeUtil.IntegerCacheSize", 600)
			.intValue();

	/** The integer cache. */
	private static Integer[] integerCache = new Integer[intCacheSize];

	/** The integer str cache. */
