...
/* ------------------------------------------------------------ */
/**
 * Fast LineInput InputStream. This buffered InputStream provides methods for
 * reading lines of bytes. The lines can be converted to String or character
 * arrays either using the default encoding or a user supplied encoding.
 * 
...
public class LineInput extends FilterInputStream {
	...
	public static class LineBuffer {
		...
		/**
		 * Instantiates a new line buffer.
		 * 
		 * @param maxLineLength
		 *            the max line length
		 */
