 ...
 * 
 * @see org.browsermob.proxy.jetty.http.HttpOutputStream
 * @version $Id: OutputObserver.java,v 1.3 2004/05/09 20:32:49 gregwilkins Exp $
 * @author Greg Wilkins (gregw)
 */
public interface OutputObserver {

	/** The Constant __CLOSED. */
	public final static int __FIRST_WRITE = 0, __RESET_BUFFER = 1,
			__COMMITING = 2, __CLOSING = 4, __CLOSED = 5;
	 ...
	 * 
	 * @param out
	 *            The OutputStream that caused the event
	 * @param action
	 *            The action taken
	 * @param data
