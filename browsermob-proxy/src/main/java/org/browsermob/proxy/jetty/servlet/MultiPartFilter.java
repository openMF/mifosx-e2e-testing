 ...
 * uses a file input item. Any files sent are stored to a tempary file and a
 * File object added to the request as an attribute. All other values are made
 * available via the normal getParameter API and the setCharacterEncoding
 * mechanism is respected when converting bytes to Strings.
 * 
...
public class MultiPartFilter implements Filter {
	...
	public void init(FilterConfig filterConfig) throws ServletException {
		tempdir = (File) filterConfig.getServletContext().getAttribute(
