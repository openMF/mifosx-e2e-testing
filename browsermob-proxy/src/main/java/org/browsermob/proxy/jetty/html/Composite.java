 ...
 * <p>
 * This class is can be used a either an abstract or concrete holder of other
 * HTML elements. Used directly, it allow multiple HTML Elements to be added
 * which are produced sequentially. Derived used of Composite may wrap each
 * contain Element in special purpose HTML tags (e.g. list).
 * 
 * <p>
 * Notes<br>
 * Elements are added to the Composite either as HTML Elements or as Strings.
 * Other objects added to the Composite are converted to Strings
 * 
 * @see Element
...
public class Composite extends Element {
	...
	/* ----------------------------------------------------------------- */
	/**
	 * Nest a Composite within a Composite. The passed Composite is added to
	 * this Composite. Adds to this composite are actually added to the nested
	 * Composite. Calls to nest are passed the nested Composite
	 * 
	 * @param c
	 *            the c
	 * @return The Composite to unest on to return to the original state.
	 */
	...
	/* ----------------------------------------------------------------- */
	/**
	 * Explicit set of the Nested component. No add is performed. setNest()
	 * obeys any current nesting and sets the nesting of the nested component.
	 * 
	 * @param c
	 *            the c
	...
	/* ----------------------------------------------------------------- */
	/**
	 * Write the composite. The default implementation writes the elements
	 * sequentially. May be overridden for more specialized behaviour.
	 * 
	 * @param out
	...
	/* ----------------------------------------------------------------- */
	/*
	 * Flush is a package method used by Page.flush() to locate the most nested
	 * composite, write out and empty its contents.
	 */
	/**
	 * Flush.
	 * 
