...
/* ------------------------------------------------------------ */
/**
 * The Class SunJsseListenerMBean.
 * 
...
public class SunJsseListenerMBean extends JsseListenerMBean {
	 ...
	 */
	public SunJsseListenerMBean() throws MBeanException {
		super();
	}
	 ...
	 * 
	 * @see
	 * org.browsermob.proxy.jetty.http.jmx.JsseListenerMBean#defineManagedResource
	 * ()
	 */
