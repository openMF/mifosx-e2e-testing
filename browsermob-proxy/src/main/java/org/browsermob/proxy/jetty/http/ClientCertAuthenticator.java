...
/* ------------------------------------------------------------ */
/**
 * Client Certificate Authenticator. This Authenticator uses a client
 * certificate to authenticate the user. Each client certificate supplied is
 * tried against the realm using the Principal name as the username and a string
 * representation of the certificate as the credential.
 * 
 * @version $Id: ClientCertAuthenticator.java,v 1.15 2006/02/28 12:45:01
 *          gregwilkins Exp $
...
public class ClientCertAuthenticator implements Authenticator {
	...
	/** The _max hand shake seconds. */
	private int _maxHandShakeSeconds = 60;

	/* ------------------------------------------------------------ */
	/**
	 * Instantiates a new client cert authenticator.
	 */
	...
	/* ------------------------------------------------------------ */
	/**
	 * Gets the max hand shake seconds.
	 * 
	 * @return the max hand shake seconds
	 */
	...
	/* ------------------------------------------------------------ */
	/**
	 * Sets the max hand shake seconds.
	 * 
	 * @param maxHandShakeSeconds
	 *            Maximum time to wait for SSL handshake if Client certification
	 *            is required.
	 */
	...
	public Principal authenticate(UserRealm realm, String pathInContext,
		...
		String username = principal == null ? "clientcert" : principal
				.getName();
