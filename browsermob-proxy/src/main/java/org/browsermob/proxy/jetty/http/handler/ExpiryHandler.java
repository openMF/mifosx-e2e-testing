...
public class ExpiryHandler extends AbstractHttpHandler {
	 ...
	 * 
	 * @param ttl
	 *            The default time to live in seconds. If negative (the default)
	 *            then all content will be set to expire 01Jan1970 by default.
	 */
	...
	/* ------------------------------------------------------------ */
	/**
	 * Handle a request by pre-populating the Expires header with a a value that
	 * corresponds to now + ttl. If ttl -s negative then HttpFields.__01Jan1970
	 * is used.
	 * 
	...
	public void handle(String pathInContext, String pathParams,
		...
		if (_ttl < 0)
			...
			expires = HttpFields.formatDate(System.currentTimeMillis() + 1000L
					* _ttl, false);
