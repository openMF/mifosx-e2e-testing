 ...
 * 
 * This specialization of HttpListener is an abstract listener that can be used
 * as the basis for a specific JSSE listener.
 * 
...
public abstract class JsseListener extends SocketListener {
	...
	public static final String DEFAULT_KEYSTORE_TYPE = System.getProperty(
			KEYSTORE_TYPE_PROPERTY, KeyStore.getDefaultType());
	...
	public static final String DEFAULT_KEYSTORE_PROVIDER_CLASS = System
			.getProperty(KEYSTORE_PROVIDER_CLASS_PROPERTY);
	...
	public static final String DEFAULT_KEYSTORE_PROVIDER_NAME = System
			.getProperty(KEYSTORE_PROVIDER_NAME_PROPERTY);
