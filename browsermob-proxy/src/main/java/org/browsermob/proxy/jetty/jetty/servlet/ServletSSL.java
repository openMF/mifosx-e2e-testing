 ...
 * <p>
 * A collection of utilities required to support the SSL requirements of the
 * Servlet 2.2 and 2.3 specs.
 * 
 * <p>
...
public class ServletSSL {
	/* ------------------------------------------------------------ */
	/**
	 * Given the name of a TLS/SSL cipher suite, return an int representing it
	 * effective stream cipher key strength. i.e. How much entropy material is
	 * in the key material being fed into the encryption routines.
	 * 
	 * <p>
	 * This is based on the information on effective key lengths in RFC 2246 -
