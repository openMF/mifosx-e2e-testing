...
/* ------------------------------------------------------------------------------- */
/**
 * Blocking output stream on non-blocking SocketChannel. Makes the assumption
 * that writes will rarely need to block. All writes flush to the channel, and
 * no additional buffering is done.
 * 
