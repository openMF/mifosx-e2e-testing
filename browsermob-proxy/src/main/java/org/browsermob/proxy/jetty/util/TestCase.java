...
/*-------------------------------------------------------------------*/
/**
 * Test Harness and report. Test Harness for production of standard test
 * reports:
 * 
 * <pre>
 ...
 * </pre>
 * 
 * @see org.browsermob.proxy.jetty.util.Code
...
public class TestCase {
	...
	/** The Constant SelfFailTest. */
	static final String SelfFailTest = "org.browsermob.proxy.jetty.util.TestCase all fail";
	...
	public TestCase(String testCase) {
		if (log.isDebugEnabled())
			log.debug("Constructed test case: " + testCase);
	 ...
	 * @return Index of substring
	 */
	public int checkContains(String string, int offset, String subString,
			String check) {
	 ...
	 * @return Index of substring
	 */
	public int realCheckContains(String string, int offset, String subString,
			String check) {
		int index = -1;
		if ((string == null && subString == null)
				|| (string != null && (subString == null || (index = string
						.indexOf(subString, offset)) >= 0))) {
			// do nothing
		} else {
			reportBuf.append(testCase + " : " + check + " - ");
			passed = false;
			...
			reportBuf.append("\"");
			if (log.isDebugEnabled())
				log.debug(check + " FAILED: " + reportBuf.toString());
			reportBuf.append('\n');
		}
		return index;
	}
	 ...
	 * @return Index of substring
	 */
	public int checkNotContained(String string, int offset, String subString,
			String check) {
		int index = -1;
		if ((string == null && subString == null)
				|| (string != null && (subString == null || (index = string
	 ...
	 * 
	 * @param l1
	 *            First Long to compare
	 * @param l2
	 *            Second Long to compare
	 * @param check
	 *            Description of this check
	 */
	 ...
	 * 
	 * @param c1
	 *            First char to compare
	 * @param c2
	 *            Second char to compare
	 * @param check
	 *            Description of this check
	 */
