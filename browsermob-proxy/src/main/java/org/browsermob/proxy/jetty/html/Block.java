...
/* -------------------------------------------------------------------- */
/**
 * HTML Block Composite. Block of predefined or arbitrary type. Block types are
 * predefined for PRE, BLOCKQUOTE, CENTER, LISTING, PLAINTEXT, XMP, DIV (Left
 * and Right) and SPAN.
 * 
 * @see org.browsermob.proxy.jetty.html.Composite
 */
public class Block extends Composite {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.browsermob.proxy.jetty.html.Composite#write(java.io.Writer)
	 */
