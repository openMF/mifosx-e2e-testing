...
/* ------------------------------------------------------------ */
/**
 * HTTP Response. This class manages the headers, trailers and content streams
 * of a HTTP response. It can be used for receiving or generating requests.
 * 
...
public class HttpResponse extends HttpMessage {
	...
	/** The Constant __507_Insufficient_Storage. */
	public final static int __100_Continue = 100,
			__101_Switching_Protocols = 101, __102_Processing = 102,
			__200_OK = 200, __201_Created = 201, __202_Accepted = 202,
			__203_Non_Authoritative_Information = 203, __204_No_Content = 204,
			__205_Reset_Content = 205, __206_Partial_Content = 206,
			__207_Multi_Status = 207, __300_Multiple_Choices = 300,
			__301_Moved_Permanently = 301, __302_Moved_Temporarily = 302,
			__302_Found = 302, __303_See_Other = 303, __304_Not_Modified = 304,
			__305_Use_Proxy = 305, __400_Bad_Request = 400,
			__401_Unauthorized = 401, __402_Payment_Required = 402,
			__403_Forbidden = 403, __404_Not_Found = 404,
			__405_Method_Not_Allowed = 405, __406_Not_Acceptable = 406,
			__407_Proxy_Authentication_Required = 407,
			__408_Request_Timeout = 408, __409_Conflict = 409,
			__410_Gone = 410, __411_Length_Required = 411,
			...
			__417_Expectation_Failed = 417, __422_Unprocessable_Entity = 422,
			__423_Locked = 423, __424_Failed_Dependency = 424,
			__500_Internal_Server_Error = 500, __501_Not_Implemented = 501,
			__502_Bad_Gateway = 502, __503_Service_Unavailable = 503,
			__504_Gateway_Timeout = 504,
			__505_HTTP_Version_Not_Supported = 505,
			__507_Insufficient_Storage = 507;

	/* -------------------------------------------------------------- */
	/** The Constant __statusMsg. */
	public final static HashMap __statusMsg = new HashMap();
	static {
		// Build error code map using reflection
		try {
			Field[] fields = org.browsermob.proxy.jetty.http.HttpResponse.class
					.getDeclaredFields();
	...
	static {
		try {
			__Continue = "HTTP/1.1 100 Continue\015\012\015\012"
	...
	/* ------------------------------------------------------------ */
	/**
	 * Reset the response. Clears any data that exists in the buffer as well as
	 * the status code. If the response has been committed, this method throws
	 ...
	 * 
	 * @see
	 * org.browsermob.proxy.jetty.http.HttpMessage#writeHeader(java.io.Writer)
	 */
	...
	public void sendError(int code, String message) throws IOException {
		...
		if (code != __204_No_Content && code != __304_Not_Modified
				&& code != __206_Partial_Content && code >= 200) {
			if (getHttpContext() != null) {
				Object o = getHttpContext().getAttribute(
						HttpContext.__ErrorHandler);
				if (o != null && o instanceof HttpHandler)
					((HttpHandler) o).handle(request.getPath(), null, request,
							this);
			}
	...
	/* ------------------------------------------------------------ */
	/**
	 * Destroy the response. Help the garbage collector by null everything that
	 * we can.
	 */
	public void destroy() {
		_reason = null;
