 ...
 * HTML Element.
 * <p>
 * This abstract class is the base for all HTML Elements. The feature of an
 * abstract HTML Element is that it can be added to HTML Pages, HTML Composites
 * and several other HTML Elements derivations. Elements may also have
 * attributes set, which are handled by the derived Element.
 * 
 * @see Page
 * @see Composite
...
public abstract class Element {
	...
	/* ----------------------------------------------------------------- */
	/** The Constant ID. */
	public static final String noAttributes = "", ALIGN = "align",
			LEFT = "left", RIGHT = "right", CENTER = "center",
			VALIGN = "valign", TOP = "top", BOTTOM = "bottom",
			MIDDLE = "middle", WIDTH = "width", HEIGHT = "height",
			SIZE = "size", COLOR = "color", BGCOLOR = "bgcolor",
	 ...
	 * 
	 * @param attributes
	 *            The initial attributes of the element
	 */
	...
	/* ----------------------------------------------------------------- */
	/**
	 * Write element to a Writer. This abstract method is called by the Page or
	 * other containing Element to write the HTML for this element. This must be
	 * implemented by the derived Element classes.
	 * 
	 * @param out
	...
	/* ----------------------------------------------------------------- */
	/**
	 * Write Element to an OutputStream. Calls print(Writer) and checks errors
	 * Elements that override this method should also override write(Writer) to
	...
	/* ----------------------------------------------------------------- */
	/**
	 * Add element Attributes. The attributes are added to the Element
	 * attributes (separated with a space). The attributes are available to the
	 * derived class in the protected member String <I>attributes</I>
	 * 
	 * @param attributes
	...
	public Element attributes(String attributes) {
		if (log.isDebugEnabled() && attributes != null
				&& attributes.indexOf('=') >= 0)
			log.debug("Set attribute with old method: " + attributes + " on "
					+ getClass().getName());
	 ...
	 * 
	 * @param attributes
	 *            String of HTML attributes to add to the element. A null
	 *            attribute clears the current attributes.
	 * @return This Element so calls can be chained.
	 */
	public Element attribute(String attributes) {
		if (log.isDebugEnabled() && attributes != null
				&& attributes.indexOf('=') >= 0)
			log.warn("Set attribute with old method: " + attributes + " on "
					+ getClass().getName());
	...
	/* ----------------------------------------------------------------- */
	/**
	 * Convert Element to String. Uses write() to convert the HTML Element to a
	 * string.
	 * 
	...
	/* ----------------------------------------------------------------- */
	/**
	 * right justify. Convenience method equivalent to
	 * attribute("align","right"). Not applicable to all Elements.
	 * 
	 * @return the element
	 */
	...
	/* ----------------------------------------------------------------- */
	/**
	 * Center. Convenience method equivalent to attribute("align","center"). Not
	...
	/* ----------------------------------------------------------------- */
	/**
	 * Bottom align. Convenience method equivalent to
	 * attribute("valign","bottom"). Not applicable to all Elements.
	 * 
	 * @return the element
	 */
	...
	/* ----------------------------------------------------------------- */
	/**
	 * Middle align. Convenience method equivalent to
	 * attribute("valign","middle"). Not applicable to all Elements.
	 * 
	 * @return the element
	 */
	...
	/* ----------------------------------------------------------------- */
	/**
	 * set width. Convenience method equivalent to attribute("width",w). Not
	 * applicable to all Elements.
	 * 
	 * @param w
	 *            the w
	...
	/* ----------------------------------------------------------------- */
	/**
	 * set height. Convenience method equivalent to attribute("height",h). Not
	 * applicable to all Elements.
	 * 
	 * @param h
	 *            the h
	...
	/* ----------------------------------------------------------------- */
	/**
	 * set size. Convenience method equivalent to attribute("size",s). Not
	 * applicable to all Elements.
	 * 
	 * @param s
	 *            the s
	...
	/* ----------------------------------------------------------------- */
	/**
	 * set color. Convenience method equivalent to attribute("color",color). Not
	 * applicable to all Elements.
	 * 
	 * @param color
	 *            the color
