 ...
 * <p>
 * This class creates a form and lays out all the elements within a table. Each
 * element added has a label part and a element part. The label is displayed in
 * the form beside the element. All buttons are shown at the bottom.
 */
public class TableForm extends Form {
	 ...
	 * 
	 * @param target
	 *            The target url to send the form contents to
	 */
	 ...
	 * @param label
	 *            The label for the element in the table.
	 * @param length
	 *            the length
	 * @param value
	 *            the value
	 ...
	 */
	public TextArea addTextArea(String tag, String label, int width,
			int height, String value) {
	 ...
	 * @return the select
	 */
	public Select addSelect(String tag, String label, boolean multiple,
			int size, Enumeration values) {
	...
	/* ----------------------------------------------------------- */
	/*
	 * add a new button area. A button area is a line of a column in a table
	 * form where multiple buttons can be placed. Subsequent calls to addButton
	 * will add buttons to this area.
	 */
	/**
	 * Adds the button area.
	 * 
	 * @param label
	 *            the label
	 */
	...
	/* ----------------------------------------------------------- */
	/*
	 * add a new button row. A button row is a line of a column in a table form
	 * where multiple buttons can be placed, that is aligned with the left hand
	 * side of the TableForm Subsequent calls to addButton will add buttons to
	 * this area.
	 */
	/**
	 * Adds the button row.
	...
	/* ----------------------------------------------------------- */
	/*
	 * add a new button area to bottom of multicolumn form. A button area is a
	 * line of a table form where multiple buttons can be placed. Subsequent
	 * calls to addButton will add buttons to this area. This is the default if
	 * no call is made to newButtonArea.
	 */
	/**
	 * Buttons at bottom.
	 */
	...
	/* ----------------------------------------------------------- */
	/**
	 * Extend the usage of the current row in the form. The next element added
	 * will be added to the same row as the form and not have a label of it's
	 * own.
	 * 
	 * @return TableForm, the this pointer so that users can write:
	 * 
	 *         <pre>
	...
	/* ------------------------------------------------------------ */
	/**
	 * Set the column span of the current column. This call is needed for forms
	 * that have varying numbers of columns in different sections. NB. and
	 * column spacing counts as a column.
	 * 
	 * @param span
	 *            the new column span
	 */
	...
	/* ----------------------------------------------------------- */
	/**
	 * Start using a new Table. Anything added to the Composite parent of this
	 * object before this is called will be added between the two tables.
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.browsermob.proxy.jetty.html.Form#write(java.io.Writer)
	 */
