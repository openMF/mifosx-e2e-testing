...
public class Select extends Block {
	 ...
	 * 
	 * @param o
	 *            The name of the option (displayed in the form)
	 * @param selected
	...
	/* ----------------------------------------------------------------- */
	/**
	 * Build a select from the given array of Strings. The values of the select
	 * are the indexes into the array of the strings, which are used as the
	 * labels on the selector.
	 * 
	 * @param arr
	 ...
	 * <p>
	 * This function takes the result returned by a multi-select input and
	 * produces an integer bit-set result of the selections made. It assumes the
	 * values of the multi-select are all different powers of 2.
	 * 
	 * @param result
	 *            the result
	 * @return the int
