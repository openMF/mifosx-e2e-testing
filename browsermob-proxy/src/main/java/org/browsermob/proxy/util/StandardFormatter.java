...
/**
 * The Class StandardFormatter.
 */
public class StandardFormatter extends Formatter {

	/** The Constant CLASS_LENGTH. */
	...
	public String format(LogRecord record) {
		try {
			...
			System.err
					.println("*******************************************************");
			System.err
					.println("There was a problem formatting a log statement:");
			e.printStackTrace();
			System.err
					.println("We will return the raw message and print any stack now");
			System.err
					.println("*******************************************************");
