...
/**
 * Convenience object for generating GUIDs. Uses the SHA1PRNG algorithm if
 * available. If unavailable, it leaves this up to the JRE to provide a default.
