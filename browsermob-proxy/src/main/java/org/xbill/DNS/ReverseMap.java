 ...
 * the IPv4 address a.b.c.d, the reverse map name is d.c.b.a.in-addr.arpa. For
 * an IPv6 address, the reverse map name is ...ip6.arpa.
 * 
...
public final class ReverseMap {
	 ...
	 * array of 4 bytes (for an IPv4 address) or 16 bytes (for an IPv6 address).
	 * 
	 * @param addr
	...
	/**
	 * Creates a reverse map name corresponding to an address contained in an
	 * array of 4 integers between 0 and 255 (for an IPv4 address) or 16
	 ...
	 */
	public static Name fromAddress(String addr, int family)
			throws UnknownHostException {
