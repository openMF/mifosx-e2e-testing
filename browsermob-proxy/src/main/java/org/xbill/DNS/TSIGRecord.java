 ...
 * resolver. TSIG records provide transaction security between the sender and
 * receiver of a message, using a shared key.
 * 
 * @see Resolver
 * @see TSIG
 * 
...
public class TSIGRecord extends Record {
	...
	/**
	 * Instantiates a new tSIG record.
	 */
	TSIGRecord() {
	}
	 ...
	 * @param timeSigned
	 *            The time that this record was generated
	 * @param fudge
	 *            The fudge factor for time - if the time that the message is
	 *            received is not in the range [now - fudge, now + fudge], the
	 *            signature fails
	 * @param signature
	 *            The signature
	 * @param originalID
