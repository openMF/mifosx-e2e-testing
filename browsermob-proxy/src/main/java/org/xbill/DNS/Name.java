...
public class Name implements Comparable, Serializable {
	...
	/** The Constant LABEL_NORMAL. */
	private static final int LABEL_NORMAL = 0;

	/** The Constant LABEL_COMPRESSION. */
	private static final int LABEL_COMPRESSION = 0xC0;

	/** The Constant LABEL_MASK. */
	 ...
	 * @param message
	 *            the message
	 * @return the text parse exception
	 */
	 ...
	 */
	private final void appendFromString(String fullName, byte[] array,
			int start, int n) throws TextParseException {
		try {
	 ...
	 * 
	 * @param n
	 *            The label to be retrieved. The first label is 0.
	 * @return the label
	 */
	 ...
	 * 
	 * @param out
	 *            The output stream containing the DNS message.
	 * @param c
	 ...
	 *            The compression context, or null of no compression is desired.
	 * @param canonical
	 *            If true, emit the name in canonicalized form (all lowercase).
	 */
	 ...
	 *         greater than this name in the canonical ordering.
	 */
