...
public class DNSSEC {
	...
	/**
	 * Creates a byte array containing the concatenation of the fields of the
	 * SIG record and the message to be signed/verified. This does not perform a
	 * cryptographic digest.
	 * 
	 * @param sig
	 *            The SIG record used to sign/verify the rrset.
