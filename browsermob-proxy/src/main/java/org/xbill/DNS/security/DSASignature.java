...
/**
 * Converts DSA signatures between the RRSIG/SIG record format (as specified in
 * RFC 2536) and the format used by Java DSA routines (DER-encoded).
 * 
...
public class DSASignature {
	...
	/** The Constant ASN1_SEQ. */
	static final int ASN1_SEQ = 0x30;

	/** The Constant ASN1_INT. */
	static final int ASN1_INT = 0x2;

	/**
	 * Instantiates a new dSA signature.
	 */
	private DSASignature() {
	}

	/**
	 * Converts the signature field in a SIG record to the format expected by
	...
	/**
	 * Converts the signature generated by DSA signature routines to the one
	 * expected inside an RRSIG/SIG record.
	 * 
	 * @param params
	 *            the params
	 * @param sig
	 ...
	 */
	public static byte[] toDNS(DSAParams params, byte[] sig)
			throws SignatureException {
		int rLength, sLength;
		int rOffset, sOffset;
