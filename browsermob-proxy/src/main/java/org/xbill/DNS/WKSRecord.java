...
public class WKSRecord extends Record {
	...
	public static class Service {
		/**
		 * TCP/UDP services. This is basically copied out of RFC 1010, with
		 * MIT-ML-DEV removed, as it is not unique, and the description of
		 * SWIFT-RVF fixed.
		 */
		 ...
		 * 
		 * @param s
		 *            The textual representation of the service.
