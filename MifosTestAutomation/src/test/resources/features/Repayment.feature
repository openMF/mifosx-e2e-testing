	...
	Scenario Outline:  Repayment-389-RBI-EI-DB-DL-REC-NON-RNI-CTPD-SAR-MD-TR-1-EarlyRePayment
	...
	Scenario:  Repayment-389-RBI-EI-DB-DL-REC-NON-RNI-CTPD-SAR-MD-TR-1-EarlyRePayment
	  ...
	  @scenario2
	Scenario Outline:  Repayment-390-RBI-EI-DB-DL-REC-NON-RNI-CTPD-DL-MD-TR-1-EarlyRePayment
	  ...
	  @scenario3
	Scenario Outline:  Repayment-391-RBI-EI-DB-DL-REC-NON-RNI-CTRFD-SAR-MD-TR-1-EarlyRePayment
	...
	Scenario Outline:  Repayment-437-RBI-EI-DB-SAR-REC-NON-RNI-CTPD-SAR-MD-Y-1-EarlyRepayment
	  ...
	  Given I setup the product loan 
	   ...
	   Scenario:  Repayment-437-RBI-EI-DB-SAR-REC-NON-RNI-CTPD-SAR-MD-TR-1-EarlyRepayment
