...
public class ClientSteps {
	...
	public void I_entered_the_values_into_client_form_using(List<String> excelsheet) throws Throwable {
	...
	public void I_set_up_the_activation_and_new_create_loan(List<String> excelsheet) throws Throwable {
	...
	public void I_make_repayment_and_verified_the_following_tabs(DataTable excel) throws Throwable {
		varFrontPage.createMakeRepayment(excel);
	}
	
	@Then("^I disburse the new created loan$")
	public void I_disburse_the_new_created_loan(List<String> excelsheet) throws Throwable {
		varFrontPage.createNewLoanExcelSheet(excelsheet);
	}
}
